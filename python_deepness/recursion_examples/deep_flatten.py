...
# I'd like you to write a function deep_flatten that accepts a list of lists
...
class DeepFlattenTests(unittest.TestCase):
    ...
    def test_flatten_with_strings(self):
        ...
        if multiprocessing:
            deep_flatten = with_timeout(list_deep_flatten, timeout)
        else:
            deep_flatten = list_deep_flatten
        self.assertEqual(deep_flatten(inputs), outputs)
